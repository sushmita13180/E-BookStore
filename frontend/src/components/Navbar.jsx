...
function Navbar() {
  ...
  <div className="navbar-start">
    ...
    <a className="text-[20px] sm:text-2xl md:text-5xl font-semibold hover:cursor-pointer ">E-BookStore</a>
  </div>
...
{/* </label> */}
 {authUser ? <Logout /> :  <div className="">
    <a className="bg-black text-white rounded-md px-3 py-2 cursor-pointer hover:bg-slate-300 hover:text-black duration-300" onClick={()=>document.querySelector('#my_modal_3').showModal()}>Login</a>
    <Login />
  </div>}
</div>
</div>
